...
//	public class CS_FlipOut : CutsceneEntity
//	{
...
//		public CS_FlipOut(Player player, Entity bell,  string toLevel, bool EndLevel, bool SeamlessNextChapter, string NextChapterSSID, AreaMode ChapterAreaMode)
//		{
//			this.player = player;
...
//			Vector2 target = bell.Center + new Vector2(0f, 8f);
...
//			player.Sprite.Play("fallFast");
//			yield return 1f;
//			while ((bell.DistortionFade -= Engine.DeltaTime * 2f) > 0f)
//			{
//				yield return null;
//			}
...
//			Vector2 target = bell.Center - new Vector2(160f, 90f);
