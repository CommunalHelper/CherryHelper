...
namespace Celeste.Mod.CherryHelper
{
    ...
    public class NonReturnCrushBlock : Solid
    {
        ...
        public void Attack(Vector2 direction)
        {
            ...
            if (flag7)
            {
                NonReturnCrushBlock.MoveState moveState = this.returnStack[this.returnStack.Count - 1];
            ...
            if (flag9)
            {
                this.returnStack.Add(new NonReturnCrushBlock.MoveState(this.Position, this.crushDir));
            }
        }
        ...
        private List<NonReturnCrushBlock.MoveState> returnStack;
