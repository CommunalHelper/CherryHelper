...
{
    [CustomEntity("CherryHelper/NonReturnSokoban")]
    public class NonReturnSokoban : Solid
    {
        ...
        public void Attack(Vector2 direction)
        {
            ...
            if (flag7)
            {
                NonReturnSokoban.MoveState moveState = this.returnStack[this.returnStack.Count - 1];
            ...
            if (flag9)
            {
                this.returnStack.Add(new NonReturnSokoban.MoveState(this.Position, this.crushDir));
            }
        }
        ...
        private List<NonReturnSokoban.MoveState> returnStack;
